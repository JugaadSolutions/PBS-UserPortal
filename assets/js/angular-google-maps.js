                ...
                return c(h, e), h.include(g), h.prototype.restrict = "EMA", h.prototype.transclude = !0, h.prototype.replace = !1, h.prototype.template = '<div class="angular-google-map"><div class="angular-google-map-container">\n</div><div ng-transclude style="display: none"></div></div>', h.prototype.scope = {
                    ...
                    return g = [], a.$on("$destroy", function () {
                        ...
                        return function (i) {
                            ...
                            if (b.isDefined(a.center) || (a.center = new google.maps.LatLngBounds(h.getCoords(a.bounds.southwest), h.getCoords(a.bounds.northeast)).getCenter()), b.isDefined(a.zoom) || (a.zoom = 10), s = b.element(c), s.addClass("angular-google-map"), x = {options: {}}, e.options && (x.options = a.options), e.styles && (x.styles = a.styles), e.type && (C = e.type.toUpperCase(), google.maps.MapTypeId.hasOwnProperty(C) ? x.mapTypeId = google.maps.MapTypeId[e.type.toUpperCase()] : f.error("angular-google-maps: invalid map type '" + e.type + "'")), v = b.extend({}, r, x, {
